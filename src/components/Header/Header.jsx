...
function Header() {
  ...
  return (
    <>
      <nav className='nav flex flex-col md:flex-row justify-around fixed top-0 z-50 w-[100vw] text-xl items-center text-white bg-gradient-to-r from-blue-400 to-blue-900 opacity-90 p-3'>
        <div
