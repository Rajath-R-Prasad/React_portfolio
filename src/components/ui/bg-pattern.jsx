...
/**
 * BGPattern — drop-in background pattern component
 *
 * @param {string}  variant  - 'dots' | 'diagonal-stripes' | 'grid' | 'horizontal-lines' | 'vertical-lines' | 'checkerboard'
 * @param {string}  mask     - 'fade-center' | 'fade-edges' | 'fade-top' | 'fade-bottom' | 'fade-left' | 'fade-right' | 'fade-x' | 'fade-y' | 'none'
 * @param {number}  size     - Pattern cell size in px (default: 24)
 * @param {string}  fill     - Pattern line/dot color (default: '#252525')
